package algorytmyZbiorowDanych.zajecia21_03.zadanie1Sort;

import algorytmyZbiorowDanych.zajecia20_03.zadanie2Heap.Heap;

import java.util.Arrays;

public class Main {
    public static void main(String[] args) {
//        algorytmyZbiorowDanych.zajecia21_03.zadanie1Sort.Heap heap = new algorytmyZbiorowDanych.zajecia21_03.zadanie1Sort.Heap();
//        heap.add(25);
//        heap.add(12);
//        heap.add(11);
//        heap.add(8);
